...
for train_loader, test_loader, valid_loader in data_loaders[0:1]:
...
print("Test errors with prior: {}".format(test_errors_no_prior))
print("Test errors without prior: {}".format(test_errors_with_prior))

aml_results_dir = "./aml_results"
if not os.path.exists(aml_results_dir):
    os.mkdir(aml_results_dir)
...
aml_models_dir = "./aml_models"
if not os.path.exists(aml_models_dir):
    os.mkdir(aml_models_dir)
